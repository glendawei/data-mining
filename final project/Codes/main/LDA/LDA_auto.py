...
dates_dir_auto = os.path.join(current_dir, auto_dir, date)
...
for i in range(1, 1680):  # Adjust the range if needed
    file_path = os.path.join(docs_dir_auto, f"{i}.txt")
    date_file_path = os.path.join(dates_dir_auto, f"{i}.txt")
