...
dates_dir_semi = os.path.join(current_dir, semi_dir, date)
...
for i in range(1, 2594):  # Adjust the range if needed
    file_path = os.path.join(docs_dir_semi, f"{i}.txt")
    date_file_path = os.path.join(dates_dir_semi, f"{i}.txt")
